...
import GeolocalizacionBar from "../components/shared/GeolocalizacionBar";
...
const Perdida = () => {
  ...
  const handleLocationChange = (resultados) => {
    setResultadosUbicacion(resultados);
    // Puedes realizar acciones adicionales cuando la ubicación cambia, si es necesario
  };

  const handleClickRecentSearch = (query) => {
    console.log("Buscar:", query);
    // Aquí puedes realizar acciones adicionales cuando se selecciona una búsqueda reciente
  };
        ...
        <div className="lg:col-span-6">
          <header>
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
              ...
              {/* Barra de geolocalización */}
              <GeolocalizacionBar onLocationChange={handleLocationChange} />
              <SearchBar
