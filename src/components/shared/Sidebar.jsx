      ...
      <div>
        <ul className="pl-4">
          ...
          <li className="bg-[#675378] p-4 rounded-tl-xl rounded-bl-xl">
            <Link to="/" className="bg-[#1fccd7] p-4 flex justify-center rounded-xl text-white">
              <GiDogHouse className="text-2xl" />
            </Link>
          </li>

          <li className="hover:bg-[#675378] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
            <Link to="/adopcion" className="group-hover:bg-[#1fccd7] p-4 flex justify-center rounded-xl text-[#1fccd7] group-hover:text-white transition-colors">
              <PiDogFill className="text-2xl" />
            </Link>
          </li>

          <li className="hover:bg-[#675378] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
            <a href="#" className="group-hover:bg-[#1fccd7] p-4 flex justify-center rounded-xl text-[#1fccd7] group-hover:text-white transition-colors">
